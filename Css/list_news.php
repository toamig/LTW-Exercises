    ...
    <section id="news">
      ...
      <article>
        ...
        <footer>
          ...
          <span class="tags"><a href="index.html"><?=$value['tags']?></a></span>
          <span class="date"><?=$value['published']?></span>
          <a class="comments" href="http://gnomo.fe.up.pt/~up201606868/exercise3/comments.php"><?=$value['comments']?></a>
        </footer>
      </article>
      <?php
      }?>
      ...
      <article>
        ...
        <p>Suspendisse potenti. Nullam lacinia dictum massa sed sagittis. Sed id ultrices libero. Cras convallis commodo ante, quis sagittis erat vulputate et. Cras nunc lorem, mollis a nibh eget, dignissim auctor lorem. Suspendisse placerat convallis ante vitae dapibus. Donec tellus felis, tincidunt eget iaculis eget, varius non turpis. Curabitur in eros at sapien fringilla venenatis eu a risus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Pellentesque eu consectetur tellus. Suspendisse vitae urna ex. Cras sit amet enim id turpis gravida lacinia a vitae lacus. Vivamus augue ante, pellentesque sed semper non, rutrum ornare ante. Orci varius.</p>
        <footer>
